...
public class A_AboutGenericsBasics {
	...
	public void a_____think_about_situations_when_class_has_meaning_as_a_container_or_context_for_another_class(){
		// actually we can do 3 things:
		// - extend base class for all types of use: DogHouse, ManHouse, BirtdHouse etc.
		// - try to work with Object and cast where possible
		// - or use generics.
		
		// Here you can see 2nd option:
